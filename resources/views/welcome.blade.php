                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="section-header">
                                <h2 class="pricing-title">Our Menu List And Pricing</h2>
                                <ul id="filter-list" class="clearfix">
                                    <li class="filter" data-filter="all">All   <span class="badge badge-danger">{{ $items->count() }}</span></li>
                                    @foreach($categories as $category)
                                        <li class="filter" data-filter=".{{ $category->slug }}">{{ $category->name }}  <span class="badge badge-white">{{ $category->items->count() }}</span> </li>
                                    @endforeach
                    ...
                    <ul id="menu-pricing" class="menu-price">
                        @foreach($items as $item)
                            <li class="item {{ $item->category->slug }}">
                                ...
                                <a href="#">
                                    <img style="width: 283px; height: 230px" src="{{ asset('uploads/items/'.$item->image) }}" class="img-responsive" alt="Food" >
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2020 <a href="#">Develop By <a style="color: black" href="https://github.com/MdEahiaMondal">Md Eahia Mondal</a>  </a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a>
                    </p>
                </div>
            </div>
        </div>
